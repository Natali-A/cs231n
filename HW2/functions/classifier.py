...
class LogisticRegression():
    ...
    def calc_accuracy(self, X, y):
        ...
        correct = np.equal(y,y_pred).sum()
        accuracy = (correct / y.shape[0]) * 100.0
    ...
    def train(self, X, y, learning_rate=1e-3, reg=0, num_iters=100, batch_size=200, verbose=False):
        ...
        for it in range(num_iters):
            ...
            # generate indices
            rand_indices = np.random.choice(num_instances, batch_size, replace = True)
